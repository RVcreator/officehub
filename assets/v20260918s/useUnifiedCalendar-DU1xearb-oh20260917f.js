...
function C(e,t,n={}){let{user:q}=i(),[o,d]=(0,f.useState)([]),[p,m]=(0,f.useState)(!0),[C,w]=(0,f.useState)(null),T=(0,f.useRef)(0),E=c(l()),D=(0,f.useCallback)(async()=>{let i=++T.current;
m(!0),w(null);
let o=c(u(e)),l=c(u(t)),[f,p,D]=await Promise.allSettled([a(1,{date_from:e,date_to:t}),b(o,l),s(e,t)]);
